...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/06/2025 às 16:16
...
(6, '2025-04-02', '333903010', 'Material Eletrico,material para conservação e manutenção de Bens', 283929.86, 65597.52, 5124.80, 93271.52, 0.00, 'Pendente'),
...
(23, '2025-05-27', '333903003', '', -7693.22, 0.00, 462.40, -462.40, 0.00, '');
...
INSERT INTO `produtos` (`id`, `produto`, `classificacao`, `natureza`, `contabil`, `descricao`, `unidade`, `localizacao`, `custo`, `quantidade`, `nf`, `preco_medio`, `tipo_operacao`, `data_cadastro`, `estoque_minimo`, `categoria`) VALUES
(1, '42400050002', 'Uniformes Tecidos e Aviamentos', '333903003', '2423.03', 'RESPIRADOR DESCARTAVEL TIPO CONCHA', '2', 'xm1', 3.32300, 165, '2', 14.45, 'retirado', '2025-04-08 17:04:42', 10, ''),
(2, '42400050015', 'Uniformes Tecidos e Aviamentos', '333903003', '2423.03', 'MASCARA RESPIRATORIA TIPO SEMI-FACIAL', 'UM', 'xm1', 4.43400, 17, '1', 192.00, 'retirado', '2025-04-08 17:22:26', 5, ''),
(3, '47100016581', 'Material Eletrico,material para conservação e manutenção de Bens', '333903010', '2424.10', 'TUBO NAO METALICO AGUA 40mm 3M SIGA 0040041', 'UM', 'xm1', 44.34200, 29, '1', 1.93, 'retirado', '2025-04-08 17:28:39', 5, ''),
...
(5, '47100040108', 'Material Eletrico,material para conservação e manutenção de Bens', '333903010', '2424.10', 'TUBO NAO METALICO AGUA 20mm 3M ID 0061400', 'um', 'xm1', 32798.82000, 28, '1', 819.00, 'retirado', '2025-05-27 15:15:06', 0, ''),
...
(8, '47100040037', 'Material Eletrico,material para conservação e manutenção de Bens', '333903010', '2424.10', 'TUBO ESGOTO 100MM', 'um', 'xm1', 32798.82000, 416, '2', 79.60, 'cadastrado', '2025-05-27 15:19:37', 0, ''),
(9, '53500020089', 'Material Eletrico,material para conservação e manutenção de Bens', '333903010', '2424.10', 'LIXA 100', '123', 'xm2', 32798.82000, 27, '3', 1024.96, 'retirado', '2025-06-05 16:06:47', 0, '');
...
(22, 8, 4, '2025-06-05', 'Entrada'),
(23, 9, 32, '2025-06-05', 'Entrada'),
(24, 1, 32, '2025-06-05', 'Saida'),
(25, 9, 5, '2025-06-05', 'Saida');
...
CREATE TABLE `usuario` (
  ...
  `email` varchar(100) NOT NULL,
  `setor` enum('administrador','estoque','patrimonio','financeiro','contratos','ccoOperacao') NOT NULL,
  `cargo` varchar(50) NOT NULL,
...
('V-684C8B30CB8D9', 'teste', 'Santa Teresa', 'Lapa', 'elias', 'daniel', 'fabio', 22, 0, '2025-06-13 22:34:22', '2025-06-13 23:16:32');
