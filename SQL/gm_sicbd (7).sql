...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/09/2025 às 18:44
...
INSERT INTO `acidentes` (`id`, `data`, `descricao`, `localizacao`, `usuario`, `severidade`, `categoria`, `data_registro`, `cor`, `status`, `policia`, `bombeiros`, `samu`, `modelo`) VALUES
