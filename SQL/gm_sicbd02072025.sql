...
--
-- Extraindo dados da tabela `acidentes`
--
...
--
-- Extraindo dados da tabela `bondes`
--

INSERT INTO `bondes` (`id`, `modelo`, `capacidade`) VALUES
(1, 'BONDE 16', 0),
(2, 'BONDE 17', 0),
(3, 'BONDE 18', 0),
(4, 'BONDE 19', 0),
...
(23, '2025-05-27', '333903003', '', -7693.22, -99778753.41, -40273787.10, -99918593.23, 0.00, '');
...
(844, 'MASTER', 'Login bem-sucedido', '2025-06-24 17:48:08'),
(845, 'MASTER', 'cadastrou ou atualizou o produto no estoque', '2025-06-24 17:49:09'),
(846, 'bonde', 'Login bem-sucedido', '2025-06-27 17:03:25'),
(847, 'bonde', 'Login bem-sucedido', '2025-06-27 18:12:22'),
(848, 'MASTER', 'Login bem-sucedido', '2025-06-27 19:25:59'),
(849, 'bonde', 'Login bem-sucedido', '2025-06-30 12:46:36'),
(850, 'MASTER', 'Login bem-sucedido', '2025-06-30 13:24:55'),
...
--
-- Estrutura da tabela `maquinistas`
--
...
--
-- Extraindo dados da tabela `maquinistas`
--

INSERT INTO `maquinistas` (`id`, `nome`) VALUES
(2, 'Adriano'),
(3, 'Helio'),
(5, 'Leonardo'),
(4, 'M. Celestino'),
...
INSERT INTO `produtos` (`id`, `produto`, `classificacao`, `natureza`, `contabil`, `descricao`, `unidade`, `localizacao`, `custo`, `valor_custo_total`, `quantidade`, `nf`, `preco_medio`, `tipo_operacao`, `data_cadastro`, `estoque_minimo`, `categoria`) VALUES
(1, '42400050002', 'Uniformes Tecidos e Aviamentos', '333903003', '2423.03', 'RESPIRADOR DESCARTAVEL TIPO CONCHA', 'UM', 'xm1', 3663.05000, 771.16000, 19, '123', 192.79, 'retirado', '2025-06-24 14:49:09', 0, '');
...
INSERT INTO `transicao` (`id`, `material_id`, `quantidade`, `valor_custo_total`, `data`, `tipo`) VALUES
(1, 1, 23, 192.79, '2025-06-24', 'Entrada'),
(2, 1, 4, 771.16, '2025-06-24', 'Saida');
...
--
-- Índices para tabela `maquinistas`
--
